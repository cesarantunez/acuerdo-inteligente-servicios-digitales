...
<ul>
  ...
  <li>Guardar confidencialidad sobre la información del Cliente.</li>
    ...
    {
      id: "prevailing_language",
      number: "18",
      title: "Idioma Prevaleciente",
      isHighlighted: true,
      render(d) {
        const lang = d?.metadata?.prevailingLanguage === "en" ? "INGLÉS" : "ESPAÑOL";
        return `<p>Este contrato se presenta en versión bilingüe (español e inglés) en formato side-by-side. Ambas versiones son oficiales. En caso de discrepancia, contradicción o ambigüedad entre ambas versiones, las Partes acuerdan que prevalecerá la versión en <strong>${lang}</strong>. Las Partes declaran haber leído y comprendido ambas versiones antes de firmar.</p>`;
      },
    },
